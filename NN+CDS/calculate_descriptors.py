...
descriptors_name = ['nHbondA','nHbondD','nNH2','nAHC','nACC',
                    ...
                    'PMI2','PMI1','NPR1','NPR2']#'molar refractivity'
...
def generator(input_filename, output_filename):
    
    dataset = pd.read_csv(input_filename,header = 0)
       ...
       # print(smi)
        ...
        try:
          ...
          #  print(iter_flag)
            ...
            nonenumberlist.append(count)
            print('Molcule %d error, please check!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!' %(count))
        ...
        d_1 = rddes.CalcNumHBA(mol2)-d_n_no2
    ...
    none_mol.to_csv(input_filename.strip('\.') + '_nonenumberlist.csv', index=False)
    dataset.to_csv('indep_REMOVED_ERROR.csv', header = True)

if __name__ == '__main__':
   print('running')
   generator('indep.csv','indep_descriptor.csv')
